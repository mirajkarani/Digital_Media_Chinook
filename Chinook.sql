...
/*Total Sales by Geo - Country, State, City*/
...
/*Employees’ name, birthday, hire date, years of working with company, address, city, state, country, title, manager and manager’s title*/
...
/*Total sales $ by employee age at the time of the invoice d*/
...
/*Total sales $ by employees who are in their 30s, 40s, 50s and 60s */
